                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker" data-style="btn btn-link" name="nombre_proveedor">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="producto_nombre" id="producto_nombre" value="option1" checked>
